...
namespace Microsoft.Wim
{
	public static partial class WimgApi
	{
		...
		private static class NativeMethods
		{
			...
			[DllImport(WimgApiDllName, CallingConvention = WimgApiCallingConvention, CharSet = WimgApiCharSet, SetLastError = true)]
			[return: MarshalAs(UnmanagedType.Bool)]
			public static extern bool WIMCopyFile(string pszExistingFileName, string pszNewFileName, Microsoft.Win32.Kernel32.CopyProgressRoutine pProgressRoutine, IntPtr pvData, [MarshalAs(UnmanagedType.Bool)] ref bool pbCancel, DWORD dwCopyFlags);
